...
namespace nilnul._obj.typ_.nilable_.unprimable_.singleton_.lazy_
{
	...
	public	class Threadsable<YourClass>
		where YourClass : new()
		//where YourClass:class
	{
		...
		static Threadsable()	//due to the "Intance" body has access to "_Instance", so "_Instance will be initalized". So maybe we can remove this static constructor?
		{
