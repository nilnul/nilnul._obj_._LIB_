...
namespace nilnul.obj.abgebra_.cobiop_.semi4both_.semiring_.demi_.monoid4both_.commutive4add_._rig
{
	/// <summary>
	...
	/// </remarks>
	///
	[Obsolete(nameof(demi_.monoid4add_.commutive4add_.monoid4mul_._rig.IAnnillatored))]
