...
namespace nilnul.obj._id._nom.term.co
{
	...
	///  eg:
	///		Abc4defXy0UvwKa
	///			where 0 is a ligure, as it's followed by a capital leter, whileas 4 is not, as it's followed by a lowercase letter so it's <see cref="_idiom.concept_.IJunc"/>
