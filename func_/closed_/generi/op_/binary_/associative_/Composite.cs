...
using nilnul.obj.func.calc_.lamda.op_.unary_;
...
namespace nilnul.obj.func_.closed_.generi.op_.binary_.associative_
{
...

	{
		...
		{
			return new Generi<T>( _CompositeLeft2rightX.Lambda(par.ee.ee.flat.ee, par1.ee.ee.flat.ee) );
