...
namespace nilnul.obj.op_.binary.co.be_._distributive._right
{
		...
		
	{
		...
		/// </summary>
		/// <param name="plus">
		/// follow the convention in <see cref="obj.abgebra_.cobiop_.ISemiring"/> , putting additin first, multiplication second
		/// </param>
